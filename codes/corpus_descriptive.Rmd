...
* Literature on Active Learning
  + I found one paper written by not computer scientists (by polisci researchers at LSE, NYU and Michigan)
  [http://www-personal.umich.edu/~wmebane/Paper_Active_Learning_Approaches_for_Labeling_Text.pdf]. This paper is aimed at introducing active learning to the field and did a couple of tests on various corpora to prove the supriority of this method compared with random sampling (passive learning). 
